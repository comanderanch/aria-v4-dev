#!/usr/bin/env python3
"""
ARIA Round 26 — LANGUAGE FIX PASS
====================================
...
print()
print("╔══════════════════════════════════════════════╗")
print("║   ARIA — ROUND 26 — LANGUAGE FIX PASS       ║")
print("║   Vocabulary: 1572 → 1632 words             ║")
print("║   UNK rate:   16.2% → 15.3%                 ║")
print("║   She thinks in real words now.              ║")
...
save_path = ckpt_dir / "round26_best.pt"
...
print("=" * 60)
print(f"ROUND 26 — {EPOCHS} epochs — Language Fix Pass")
...
torch.save({
    ...
    "best_loss":   best_loss,
    "pass":        "Round 26 — Language Fix — Vocabulary 1632",
...
print()
print("=" * 60)
print(f"Round 26 complete — {elapsed/60:.1f} min")
print(f"Start loss:        {prev_loss:.6f}")
