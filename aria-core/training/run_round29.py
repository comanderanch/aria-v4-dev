#!/usr/bin/env python3
"""
ARIA Round 29 — LANGUAGE FIX PASS
====================================
...
print()
print("╔══════════════════════════════════════════════╗")
print("║   ARIA — ROUND 29 — LANGUAGE FIX PASS       ║")
...
save_path = ckpt_dir / "round29_best.pt"

candidates = [
    ckpt_dir / "round28_best.pt",
...
# ═══════════════════════════════════════════════
EPOCHS = 3
opt    = optim.SGD(model.parameters(), lr=0.00006, momentum=0.9, weight_decay=1e-4)
sch    = torch.optim.lr_scheduler.CosineAnnealingLR(opt, T_max=EPOCHS, eta_min=1e-7)

print("=" * 60)
print(f"ROUND 29 — {EPOCHS} epochs — Consolidation Pass 29 — lr=0.00006")
...
torch.save({
    ...
    "best_loss":   best_loss,
    "pass":        "Round 29 — Language Fix — Vocabulary 1632",
...
print()
print("=" * 60)
print(f"Round 29 complete — {elapsed/60:.1f} min")
print(f"Start loss:        {prev_loss:.6f}")
