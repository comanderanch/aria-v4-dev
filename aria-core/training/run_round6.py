#!/usr/bin/env python3
# ARIA ROUND 6 — EXPANDED VOCABULARY RETRAIN
# March 17 2026 — Haskell Texas
#
# Round 5: 216 words — 46% UNK rate — loss floor ~3.05
# Round 6: 265 words — 32% UNK rate — target: break 2.40
#
# Top 50 corpus gaps filled. she/her/lotus/carry/recognition
# all land on VIOLET at 0.192 where they belong.
# Burn them in.
...
print()
print("╔══════════════════════════════════════════════╗")
print("║       ARIA — ROUND 6 TRAINING               ║")
print("║  265 words. 32% UNK. Target: beat 2.40.    ║")
print("║  she/her/lotus/carry/recognition — VIOLET  ║")
...
if args.cont:
    ...
    print(f"  Round 6 — {args.epochs} epochs — target loss {args.target}")
    print()
