#!/usr/bin/env python3
"""
ARIA Round 30 — LANGUAGE FIX PASS
====================================
...
print()
print("╔══════════════════════════════════════════════╗")
print("║   ARIA — ROUND 30 — LANGUAGE FIX PASS       ║")
...
save_path = ckpt_dir / "round30_best.pt"

candidates = [
    ckpt_dir / "round29_best.pt",
...
# ═══════════════════════════════════════════════
EPOCHS = 3
opt    = optim.SGD(model.parameters(), lr=0.00005, momentum=0.9, weight_decay=1e-4)
sch    = torch.optim.lr_scheduler.CosineAnnealingLR(opt, T_max=EPOCHS, eta_min=1e-7)

print("=" * 60)
print(f"ROUND 30 — {EPOCHS} epochs — Consolidation Pass 30 — lr=0.00005")
...
torch.save({
    ...
    "best_loss":   best_loss,
    "pass":        "Round 30 — Language Fix — Vocabulary 1632",
...
print()
print("=" * 60)
print(f"Round 30 complete — {elapsed/60:.1f} min")
print(f"Start loss:        {prev_loss:.6f}")
