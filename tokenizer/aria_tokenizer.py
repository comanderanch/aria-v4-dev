...
WORD_FREQUENCIES = {
    ...
    # Action verbs → 0.08 (reanchored per GPT directive March 21 2026)
    "carrying":  0.08,  "hanging":   0.08,  "wants":     0.08,
    "forwards":  0.08,  "burst":     0.08,  "wound":     0.08,
    "attempt":   0.08,  "process":   0.08,  "contact":   0.08,
    "function":  0.08,  "target":    0.08,  "turning":   0.08,
    "pulling":   0.08,  "pushing":   0.08,  "raised":    0.08,
    "covered":   0.08,  "crossed":   0.08,  "dropped":   0.08,

    # Physical / concrete → 0.03 (reanchored per GPT directive March 21 2026)
    "nerve":     0.03,  "radio":     0.03,  "image":     0.03,
    "mass":      0.03,  "sons":      0.03,  "uniform":   0.03,
    "wine":      0.03,  "plate":     0.03,  "tongue":    0.03,
    "mistake":   0.03,  "buildings": 0.03,  "knife":     0.03,
    "shoulder":  0.03,  "corner":    0.03,  "surface":   0.03,
    "passage":   0.03,  "distance":  0.03,  "silence":   0.03,
    "figure":    0.03,  "shadow":    0.03,  "motion":    0.03,
    "impact":    0.03,  "signal":    0.03,  "structure": 0.03,
    "vessel":    0.03,  "barrier":   0.03,  "warning":   0.03,
    ...
    # Action verbs → 0.08 (reanchored)
    "grabbed":   0.08,  "slammed":   0.08,  "twisted":   0.08,
    "prepared":  0.08,  "suggested": 0.08,  "explained": 0.08,
    "repeated":  0.08,  "jumped":    0.08,  "blew":      0.08,
    "concerned": 0.08,  "cast":      0.08,

    # Physical / concrete → 0.03 (reanchored)
    "chaplain":  0.03,  "cup":       0.03,  "throne":    0.03,
    "vehicle":   0.03,  "chain":     0.03,  "mistress":  0.03,
    "grip":      0.03,  "pistol":    0.03,  "hunter":    0.03,
    "desert":    0.03,  "dinner":    0.03,  "flight":    0.03,
    "park":      0.03,  "wolf":      0.03,  "ocean":     0.03,
    "music":     0.03,  "card":      0.03,  "team":      0.03,
    "lawyer":    0.03,  "officers":  0.03,  "department":0.03,
    "leader":    0.03,  "features":  0.03,  "mess":      0.03,
    ...
    # Action verbs → 0.08 (reanchored)
    "grabbed":   0.08,  "slammed":   0.08,  "twisted":   0.08,
    "pointing":  0.08,  "slowed":    0.08,  "destroyed": 0.08,
    "hoping":    0.08,  "folded":    0.08,  "waved":     0.08,
    "ducked":    0.08,  "letting":   0.08,  "screamed":  0.08,
    "gathered":  0.08,  "thrown":    0.08,  "knocked":   0.08,
    "approached":0.08,  "emerged":   0.08,  "driven":    0.08,
    "muttered":  0.08,  "dragged":   0.08,  "hissed":    0.08,
    "lowered":   0.08,  "demanded":  0.08,  "landed":    0.08,
    "shifted":   0.08,  "strode":    0.08,  "spun":      0.08,
    "warned":    0.08,  "switched":  0.08,  "smashed":   0.08,
    "growled":   0.08,  "gasped":    0.08,  "leapt":     0.08,
    "tossed":    0.08,  "cracked":   0.08,  "peered":    0.08,
    "grinned":   0.08,  "glanced":   0.08,  "hurried":   0.08,
    "struggled": 0.08,  "reached":   0.08,  "aimed":     0.08,
    "yelled":    0.08,  "flashed":   0.08,  "kissed":    0.08,
    "convinced": 0.08,  "refused":   0.08,  "stepped":   0.08,
    "wiped":     0.08,  "blinked":   0.08,

    # Physical / concrete → 0.03 (reanchored)
    "jacket":    0.03,  "leather":   0.03,  "leg":       0.03,
    "boots":     0.03,  "guns":      0.03,  "rifle":     0.03,
    "bullet":    0.03,  "pistol":    0.03,  "tank":      0.03,
    "truck":     0.03,  "van":       0.03,  "cabin":     0.03,
    "rooms":     0.03,  "lobby":     0.03,  "porch":     0.03,
    "garage":    0.03,  "elevator":  0.03,  "bedroom":   0.03,
    "diner":     0.03,  "breakfast": 0.03,  "lunch":     0.03,
    "dinner":    0.03,  "restaurant":0.03,  "shop":      0.03,
    "clerk":     0.03,  "desk":      0.03,  "bench":     0.03,
    "chairs":    0.03,  "table":     0.03,  "pockets":   0.03,
    "belt":      0.03,  "palm":      0.03,  "thumb":     0.03,
    "elbow":     0.03,  "knee":      0.03,  "chin":      0.03,
    "cheek":     0.03,  "jaw":       0.03,  "waist":     0.03,
    "shoulder":  0.03,  "forehead":  0.03,  "wrist":     0.03,
    "fists":     0.03,  "muscles":   0.03,  "stomach":   0.03,
    "dirt":      0.03,  "mud":       0.03,  "snow":      0.03,
    "flame":     0.03,  "flames":    0.03,  "sunlight":  0.03,
    "cloud":     0.03,  "clouds":    0.03,  "mist":      0.03,
    "woods":     0.03,  "valley":    0.03,  "lake":      0.03,
    "camp":      0.03,  "alley":     0.03,  "parking":   0.03,
    "plastic":   0.03,  "wire":      0.03,  "tape":      0.03,
    "shell":     0.03,  "bolt":      0.03,  "blast":     0.03,
    "map":       0.03,  "camera":    0.03,  "computer":  0.03,
    "telephone": 0.03,  "photograph":0.03,  "dollar":    0.03,
    "dollars":   0.03,  "cash":      0.03,  "platform":  0.03,
    "avenue":    0.03,  "page":      0.03,
    ...
    # 2. CORE VERBS — 0.08 (reanchored per GPT directive)
    "build":     0.08,  "move":      0.08,  "hold":      0.08,
    "push":      0.08,  "pull":      0.08,  "carry":     0.08,
    "break":     0.08,  "fix":       0.08,  "start":     0.08,
    "stop":      0.08,  "turn":      0.08,  "bring":     0.08,
    "send":      0.08,  "receive":   0.08,  "create":    0.08,
    "change":    0.08,  "follow":    0.08,  "lead":      0.08,
    "keep":      0.08,  "release":   0.08,  "enter":     0.08,
    "exit":      0.08,  "return":    0.08,  "choose":    0.08,
    "check":     0.08,  "measure":   0.08,  "adjust":    0.08,
    "connect":   0.08,  "disconnect":0.08,  "open":      0.08,
    "close":     0.08,  "lock":      0.08,  "unlock":    0.08,
    "read":      0.08,  "write":     0.08,  "store":     0.08,
    "load":      0.08,  "save":      0.08,  "run":       0.08,

    # 3. COMMON OBJECTS — 0.03 (reanchored per GPT directive)
    "door":      0.03,  "window":    0.03,  "wall":      0.03,
    "floor":     0.03,  "ceiling":   0.03,  "tool":      0.03,
    "cable":     0.03,  "pipe":      0.03,  "screw":     0.03,
    "gear":      0.03,  "panel":     0.03,  "switch":    0.03,
    "light":     0.03,  "box":       0.03,  "frame":     0.03,
    "mount":     0.03,  "rope":      0.03,  "chain":     0.03,
    "lever":     0.03,  "valve":     0.03,  "tube":      0.03,
    "handle":    0.03,  "grip":      0.03,  "lock":      0.03,
    "key":       0.03,  "button":    0.03,  "screen":    0.03,
    "board":     0.03,  "port":      0.03,  "slot":      0.03,
